...
class DownloadsViewController: UIViewController {
    ...
    private let downoladedTable: UITableView = {
    ...
    override func viewDidLoad() {
        ...
        title = "Downlods"
        view.addSubview(downoladedTable)
        navigationController?.navigationBar.prefersLargeTitles = true
        navigationController?.navigationItem.largeTitleDisplayMode = .always
        downoladedTable.delegate = self
        downoladedTable.dataSource = self
        ...
        DataPersistanceManager.shared.fetchingTitlesFromDataBase { [weak self] result in
            ...
            case .success(let titles):
                ...
                DispatchQueue.main.async {
                    self?.downoladedTable.reloadData()
                }
    ...
    override func viewDidLayoutSubviews() {
        ...
        downoladedTable.frame = view.bounds
    }
